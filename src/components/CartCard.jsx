...
const CartCard = ({ title, price, image }) => {
  return (
    <div className="w-[370px] h-[465px] relative group ">
      <div className="z-10 absolute top-5 left-5 bg-black py-3 px-8 text-white text-base font-dm font-bold">
        New
      </div>
      <div className="w-[370px] h-[370px] relative overflow-hidden">
